...
public class LineALSolved {
	 ...
	 */
	public LineALSolved(double slope, double yIntercept) {
		this.slope = slope;
	 ...
	 */
	public LineALSolved(LineALSolved l) {
		this.slope = l.slope;
	 ...
	 */
	public LineALSolved(Point2D.Double p1, Point2D.Double p2) {
	...
	public boolean equals(Object o) {
		if (!(o instanceof LineALSolved)) return false;
		LineALSolved l = (LineALSolved) o;
	 ...
	 */
	public boolean isPerpendicular(LineALSolved l2) {
	 ...
	 */
	public LineALSolved translate(double deltaX, double deltaY) {
		return new LineALSolved(this.slope, this.yIntercept + deltaY - (slope * deltaX));
	}
	
	/*
	 * Returns true if and only if some Line from the given list have the same slope as the target Line
	 */
	public boolean hasWithSameSlope(ArrayList<LineALSolved> list) {
	 ...
	 */
	public ArrayList<LineALSolved> addTo(ArrayList<LineALSolved> lines) {
	 ...
	 */
	public static boolean hasParellels(ArrayList<LineALSolved> lines) {
		for(int i = 0; i < lines.size(); i++) {
	 ...
	 */
	public static ArrayList<LineALSolved> notHorizontal(ArrayList<LineALSolved> lines) {
		ArrayList<LineALSolved> result = new ArrayList<LineALSolved>();
		for(int i = 0; i < lines.size(); i++) {
